...
func main() {
	...
	fail.FailedOnError(err, "Failed to declear queue demo-q-1")
	...
	fail.FailedOnError(err0, "failed consume")
	...
	fail.FailedOnError(err, "publish faled")
	...
	fail.FailedOnError(err, "declare queue-2 failed")
	q3, err := chAdp.QueueDeclare("queue-3", true, false, false, false, nil)
	fail.FailedOnError(err, "declare queue-3 failed")
	...
	fail.FailedOnError(err, "Consume queue-2 failed")
